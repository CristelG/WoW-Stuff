...
local function SetupTutorials()
	T.RegisterTutorial(helpName, {
		...
		{	-- 11
			text = cTitle.."         What's NEW in version |r|cffffffff4.2.6|r\n\n"..
					"- FIXED - issue #469 - Error when clicking on Q/WQ POI on map\n"..
					"- FIXED - Quest Item tag - Wrong tag position when Group Find button is shown\n"..
					"- UPDATED - Filters - If group of quests is group of campaign, is added suffix\n"..
